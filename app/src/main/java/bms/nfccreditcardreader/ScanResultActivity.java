    ...
    protected void onResume()
    {
        ...
        if (nfcAdapter != null && !nfcAdapter.isEnabled())
        {
            ...
            new AlertDialog.Builder(this)
                    .setTitle("NFC ist ausgeschaltet.")
                    .setMessage("Solltest du NFC nicht anschalten, um es zu benutzen?")
                    ...
                    .setNegativeButton("Vielleicht später", new DialogInterface.OnClickListener()
                    {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i)
                        {
