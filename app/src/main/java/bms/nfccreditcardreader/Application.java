...
public class Application extends android.app.Application
{
    ...
    public void onCreate()
    {
        ...
        if (!triangleSession.isInitialized())
        {
            ...
            final String applicationId = "3safihkkMSSjxjs";
            final String accessKey = "t8pc2iotGe";
            final String secretKey = "YqBy3YEHHhDWA4rvcLFna2TADiNBjxFbsuQQGinz6EePNwxkKx5DOj3Vx1UKb2n9" ;
